...
security: "DEFINER"
criada_em: "2026-06-01 17:53:09"
alterada_em: "2026-06-01 17:53:09"
execucoes: 216
...
- **Escreve:** [[dashboard_affiliate_nutra_usd_stage]]
- **Cria:** —
- **Trunca:** [[dashboard_affiliate_nutra_usd_stage]]
- **Dropa:** —
- **Chama:** —
...
| Erros | 0 |
| Warnings | 2,814,941 |
| Linhas afetadas (total) | 17,175,399 |
...
BEGIN
    ...
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
        BEGIN
            TRUNCATE TABLE instituto_experience.dashboard_affiliate_nutra_usd_stage;
            RESIGNAL;
        END;

    TRUNCATE TABLE instituto_experience.dashboard_affiliate_nutra_usd_stage;

    INSERT INTO instituto_experience.dashboard_affiliate_nutra_usd_stage (
        created_at_date,
        clean_product_name,
        platform,
        affiliate_name,
    ...
    RENAME TABLE
        instituto_experience.dashboard_affiliate_nutra_usd       TO instituto_experience.dashboard_affiliate_nutra_usd_old,
        instituto_experience.dashboard_affiliate_nutra_usd_stage TO instituto_experience.dashboard_affiliate_nutra_usd,
        instituto_experience.dashboard_affiliate_nutra_usd_old   TO instituto_experience.dashboard_affiliate_nutra_usd_stage;
