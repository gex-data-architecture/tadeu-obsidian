...
| Ambiente | develop |
| Formato | parquet |
| Location (S3) | `s3://api-buygoods-teste-tadeu/bronze/buygoods/orders` |
| Tipo | EXTERNAL_TABLE |
| Partições | acct_id, year_month |
| Nº colunas | 139 |
| Atualizada em | 2026-05-29 09:59:28-03:00 |
...
| 137 | _extract_account_id | string |
| 138 | _extract_date | string |
| 139 | _extracted_at | string |
