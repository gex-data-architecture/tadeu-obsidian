...
| Script | `s3://gex-datalake-bronze-develop/scripts/buygoods_gold/jobs/gold_build_buygoods.py` |
| Criado | 2026-06-02 14:24:02.331000-03:00 |
| Modificado | 2026-06-03 13:59:28.715000-03:00 |
...
| `--DB_TABLE` | tb_gex_gold_buygoods_dev |
...
| `--SOURCE_TABLE` | tb_gex_buygoods_unified_dev |
...
> Fonte: `s3://gex-datalake-bronze-develop/scripts/buygoods_gold/jobs/gold_build_buygoods.py` — baixado do S3 (read-only).
