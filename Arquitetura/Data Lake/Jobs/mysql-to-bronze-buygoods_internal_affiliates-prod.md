...
| Script | `s3://gex-datalake-bronze-prod/scripts/mysql_to_bronze_buygoods_internal_affiliates.py` |
| Criado | 2026-05-14 16:18:31.040000-03:00 |
| Modificado | 2026-05-14 16:18:31.040000-03:00 |
...
| `--db_table` | buygoods_internal_affiliates |
...
|---|---|--:|---|
| 2026-06-02 22:00 | SUCCEEDED | 1m16s | — |
| 2026-06-01 22:00 | SUCCEEDED | 1m11s | — |
| 2026-05-31 22:00 | SUCCEEDED | 1m8s | — |
| 2026-05-30 22:00 | SUCCEEDED | 1m10s | — |
| 2026-05-29 22:00 | SUCCEEDED | 1m7s | — |
| 2026-05-28 22:00 | SUCCEEDED | 1m8s | — |
| 2026-05-27 22:00 | SUCCEEDED | 59s | — |
| 2026-05-26 22:00 | SUCCEEDED | 1m5s | — |

## Script

> Fonte: `s3://gex-datalake-bronze-prod/scripts/mysql_to_bronze_buygoods_internal_affiliates.py` — baixado do S3 (read-only).
...
# ======================================================
# PARAMETROS: buygoods_internal_affiliates
# ======================================================
DATABASE    = "instituto_experience"
TABLE       = "buygoods_internal_affiliates"
...
# ======================================================
# 3. Transformacao minima - adiciona dt_proc
# ======================================================
df = datasource.toDF()
