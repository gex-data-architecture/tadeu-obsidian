...
tipo_job: glueetl
glue_version: 4.0
ultima_execucao: 2026-05-14 14:40
...
| Script | `s3://gex-datalake-bronze-develop/scripts/bronze_to_silver_buygoods.py` |
| Criado | 2026-05-12 15:03:22.869000-03:00 |
| Modificado | 2026-05-14 14:53:41.701000-03:00 |
...
|---|---|--:|---|
| 2026-05-14 14:40 | SUCCEEDED | 4m16s | — |
| 2026-05-14 14:28 | STOPPED | 10m41s | — |
| 2026-05-14 11:39 | FAILED | 1m28s | Error Category: RESOURCE_NOT_FOUND_ERROR; Failed Line Number: 558; Spark Error Class: MISSING_COLUMN; AnalysisException:… |
| 2026-05-14 10:27 | FAILED | 1m24s | Error Category: RESOURCE_NOT_FOUND_ERROR; Failed Line Number: 558; Spark Error Class: MISSING_COLUMN; AnalysisException:… |
| 2026-05-12 15:18 | FAILED | 1m7s | Error Category: RESOURCE_NOT_FOUND_ERROR; Failed Line Number: 126; Spark Error Class: MISSING_COLUMN; AnalysisException:… |

## Script

> Fonte: `s3://gex-datalake-bronze-develop/scripts/bronze_to_silver_buygoods.py` — baixado do S3 (read-only).
...
if internal_raw.rdd.isEmpty():
    ...
    internal_aff = (
        ...
        .select("affiliate_id", "traffic_source", "traffic_manager", "is_internal_flag")
        .dropDuplicates(["affiliate_id"])
    )
...
enriched = (
    ...
    .join(internal_aff, on=["affiliate_id"], how="left")
...
result = (
    ...
    .withColumn("offer_name", F.coalesce(F.col("offer_name"), F.col("product_name")))
