...
tipo_job: glueetl
glue_version: 4.0
ultima_execucao: 2026-06-01 07:12
...
| Timeout (min) | 60 |
| Max retries | 0 |
| Role | `arn:aws:iam::406933028738:role/buygoods-glue-silver-role` |
| Script | `s3://api-buygoods-teste-tadeu/glue/scripts/glue_buygoods_silver.py` |
| Criado | 2026-05-29 15:59:48.904000-03:00 |
| Modificado | 2026-05-29 15:59:48.904000-03:00 |

## Parâmetros de negócio

| Argumento | Valor |
|---|---|
| `--REF_DATABASE` | gex_db_prod_bronze |
| `--SOURCE_DATABASE` | gex_db_develop_bronze |
| `--SOURCE_PATH` | s3://api-buygoods-teste-tadeu/bronze/buygoods/orders/ |
| `--SOURCE_TABLE` | buygoods_orders |
| `--TARGET_DATABASE` | gex_db_develop_silver |
| `--TARGET_TABLE` | buygoods_orders |
...
|---|---|--:|---|
| 2026-06-01 07:12 | SUCCEEDED | 4m23s | — |
| 2026-06-01 05:12 | SUCCEEDED | 4m42s | — |
| 2026-06-01 03:55 | SUCCEEDED | 4m9s | — |
| 2026-06-01 01:11 | SUCCEEDED | 4m20s | — |
| 2026-05-31 23:09 | SUCCEEDED | 4m17s | — |
| 2026-05-31 21:09 | SUCCEEDED | 4m29s | — |
| 2026-05-31 19:18 | SUCCEEDED | 4m17s | — |
| 2026-05-31 17:15 | SUCCEEDED | 4m28s | — |

## Script

> Fonte: `s3://api-buygoods-teste-tadeu/glue/scripts/glue_buygoods_silver.py` — baixado do S3 (read-only).
