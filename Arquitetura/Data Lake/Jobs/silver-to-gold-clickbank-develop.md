...
> Glue ETL · fluxo **silver-to-gold** · ambiente **develop**
...
| Script | `s3://gex-datalake-bronze-develop/scripts/silver_to_gold_clickbank.py` |
| Criado | 2026-04-16 11:34:21.492000-03:00 |
| Modificado | 2026-04-23 11:23:15.803000-03:00 |
...
| `--TARGET_DATABASE` | gex_db_develop_gold |
| `--db_table` | gex_gold_clickbank |
...
> Fonte: `s3://gex-datalake-bronze-develop/scripts/silver_to_gold_clickbank.py` — baixado do S3 (read-only).
