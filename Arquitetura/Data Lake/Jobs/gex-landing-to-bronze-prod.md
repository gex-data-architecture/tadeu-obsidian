...
| Script | `s3://gex-datalake-bronze-prod/scripts/landing_to_bronze.py` |
| Criado | 2026-03-25 09:47:36.864000-03:00 |
| Modificado | 2026-04-01 17:19:14.758000-03:00 |
...
|---|---|--:|---|
| 2026-04-10 02:00 | SUCCEEDED | 1m13s | — |
| 2026-04-09 02:00 | SUCCEEDED | 1m25s | — |
| 2026-04-08 02:00 | SUCCEEDED | 1m23s | — |
| 2026-04-07 02:00 | SUCCEEDED | 1m26s | — |
| 2026-04-06 18:57 | FAILED | 41s | AnalysisException: Unable to infer schema for JSON. It must be specified manually. |
| 2026-04-06 18:37 | FAILED | 39s | AnalysisException: Unable to infer schema for JSON. It must be specified manually. |
| 2026-04-06 18:17 | FAILED | 1m1s | AnalysisException: Unable to infer schema for JSON. It must be specified manually. |
| 2026-04-06 17:57 | FAILED | 39s | AnalysisException: Unable to infer schema for JSON. It must be specified manually. |

## Script

> Fonte: `s3://gex-datalake-bronze-prod/scripts/landing_to_bronze.py` — baixado do S3 (read-only).
