...
tipo_job: glueetl
glue_version: 4.0
ultima_execucao: 2026-06-01 07:17
...
> Glue ETL · fluxo **to-mysql** · ambiente **?**
...
| Script | `s3://api-buygoods-teste-tadeu/glue/scripts/glue_silver_to_mysql.py` |
| Criado | 2026-05-29 18:32:25.675000-03:00 |
| Modificado | 2026-05-29 18:32:25.675000-03:00 |

## Parâmetros de negócio

| Argumento | Valor |
|---|---|
| `--DB_TABLE` | buygoods_silver_orders |
| `--GLUE_CONNECTION_NAME` | gex-mysql-connection-prod |
| `--MIN_ROWS_THRESHOLD` | 100 |
| `--SOURCE_DATABASE` | gex_db_develop_silver |
...
|---|---|--:|---|
| 2026-06-01 07:17 | SUCCEEDED | 1m40s | — |
| 2026-06-01 05:17 | SUCCEEDED | 1m38s | — |
| 2026-06-01 04:00 | SUCCEEDED | 1m52s | — |
| 2026-06-01 01:16 | SUCCEEDED | 1m47s | — |
| 2026-05-31 23:14 | SUCCEEDED | 1m37s | — |
| 2026-05-31 21:14 | SUCCEEDED | 2m0s | — |
| 2026-05-31 19:23 | SUCCEEDED | 2m16s | — |
| 2026-05-31 17:20 | SUCCEEDED | 1m41s | — |

## Script

> Fonte: `s3://api-buygoods-teste-tadeu/glue/scripts/glue_silver_to_mysql.py` — baixado do S3 (read-only).
