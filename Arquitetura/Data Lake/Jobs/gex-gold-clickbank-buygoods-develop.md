...
| Script | `s3://gex-datalake-bronze-develop/scripts/gold_clickbank_buygoods_build.py` |
| Criado | 2026-06-10 10:55:07.960000-03:00 |
| Modificado | 2026-06-10 11:44:55.495000-03:00 |

## Parâmetros de negócio

| Argumento | Valor |
|---|---|
| `--BUYGOODS_TABLE` | tb_gex_gold_buygoods_dev |
| `--CLICKBANK_TABLE` | gold_clickbank_aws |
| `--DB_TABLE` | tb_gex_gold_clickbank_buygoods_dev |
...
> Fonte: `s3://gex-datalake-bronze-develop/scripts/gold_clickbank_buygoods_build.py` — baixado do S3 (read-only).
