...
| Criada | 2026-04-23 14:34:13.849000-03:00 |

## Fluxo (passo a passo do ASL)

> Sequência dos estados a partir do `StartAt` (jobs ▶️, crawlers 🕷️, SFN ⤵️).

- ▶️ job [[gold-dashboard-channels-marketing-prod]]
- 🕷️ crawler [[gex-gold-dashboard-channels-marketing-crawler-prod]]
- ✅ fim (sucesso)

## Encadeamento (EventBridge)

**Agendada (EventBridge schedule):**
- `gex-gold-dashboard-channels-marketing-timer-prod` _(desabilitada)_ — todo dia a cada 15 min a partir do min 20 UTC · expressão `cron(20/15 * * * ? *)`

## Dispara (alvos)

- **Jobs:** [[gold-dashboard-channels-marketing-prod]]
- **Crawlers:** [[gex-gold-dashboard-channels-marketing-crawler-prod]]
- **SFN aninhadas:** —
...
````json
{
  ...
  "States": {
    "Atualizar_Catalogo_H5_Gold": {
      ...
      "Next": "Finalizar_Com_Sucesso",
      "Parameters": {
        "Name": "gex-gold-dashboard-channels-marketing-crawler-prod"
      },
    ...
    "Rodar_H5_Gold_Job": {
      ...
      "Parameters": {
        "JobName": "gold-dashboard-channels-marketing-prod"
      },
