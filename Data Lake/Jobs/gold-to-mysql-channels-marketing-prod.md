...
tipo_job: glueetl
glue_version: 4.0
ultima_execucao: 2026-04-24 17:41
...
| Script | `s3://gex-datalake-bronze-prod/scripts/glue_job_channels_marketing_to_mysql.py` |
| Criado | 2026-04-24 14:32:41.471000-03:00 |
| Modificado | 2026-04-24 17:35:08.808000-03:00 |
...
|---|---|--:|---|
| 2026-04-24 17:41 | SUCCEEDED | 1m58s | — |
| 2026-04-24 17:36 | FAILED | 1m50s | Error Category: INVALID_ARGUMENT_ERROR; Failed Line Number: 194; ValueError: Cannot parse JDBC URL: 'jdbc:mysql://instit… |
| 2026-04-24 17:11 | STOPPED | 12m46s | — |
| 2026-04-24 15:15 | FAILED | 6m47s | LAUNCH ERROR / Python Module Installer indicates modules that failed to install, check logs from the PythonModuleInstall… |
| 2026-04-24 15:06 | FAILED | 6m52s | LAUNCH ERROR / Python Module Installer indicates modules that failed to install, check logs from the PythonModuleInstall… |
| 2026-04-24 14:56 | FAILED | 6m47s | LAUNCH ERROR / Python Module Installer indicates modules that failed to install, check logs from the PythonModuleInstall… |
| 2026-04-24 14:42 | FAILED | 6m47s | LAUNCH ERROR / Python Module Installer indicates modules that failed to install, check logs from the PythonModuleInstall… |
| 2026-04-24 14:38 | FAILED | 17s | LAUNCH ERROR / Error downloading from S3 for bucket: gex-datalake-bronze-prod, key: jars/mysql-connector-j-8.0.33.jar.Th… |

## Script

> Fonte: `s3://gex-datalake-bronze-prod/scripts/glue_job_channels_marketing_to_mysql.py` — baixado do S3 (read-only).
