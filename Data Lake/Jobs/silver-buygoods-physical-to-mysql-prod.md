...
| Script | `s3://gex-datalake-bronze-prod/scripts/glue_job_silver_buygoods_physical_to_mysql.py` |
| Criado | 2026-05-21 16:08:58.621000-03:00 |
| Modificado | 2026-05-27 15:43:33.607000-03:00 |
...
| `--db_table` | tb_gex_buygoods_physical_new |
...
|---|---|--:|---|
| 2026-06-03 13:42 | SUCCEEDED | 4m44s | — |
| 2026-06-03 13:22 | SUCCEEDED | 3m59s | — |
| 2026-06-03 11:42 | SUCCEEDED | 3m51s | — |
| 2026-06-03 09:42 | SUCCEEDED | 3m40s | — |
| 2026-06-03 07:41 | SUCCEEDED | 3m52s | — |
| 2026-06-03 05:41 | SUCCEEDED | 4m21s | — |
| 2026-06-03 03:42 | SUCCEEDED | 6m8s | — |
| 2026-06-03 01:41 | SUCCEEDED | 4m16s | — |

## Script

> Fonte: `s3://gex-datalake-bronze-prod/scripts/glue_job_silver_buygoods_physical_to_mysql.py` — baixado do S3 (read-only).

````python
"""
Glue Job: gex-silver-buygoods-physical-to-mysql

Replicates tb_buygoods_physical_new from Glue Catalog/Athena
into MySQL table tb_gex_buygoods_physical_new using atomic table swap.
...
=== JOB FLOW ===
  ...
  [STEP 4] Write to staging table with overwrite mode
  [STEP 5] Validate staging row count
  [STEP 6] Atomic RENAME TABLE swap
  [STEP 7] Recycle backup back into staging
"""
...
SOURCE_TABLE = "tb_buygoods_physical_new"
MYSQL_TABLE = "tb_gex_buygoods_physical_new"
STAGING_TABLE = "tb_gex_buygoods_physical_new_old"
...
def read_source_snapshot() -> tuple[object, int]:
    ...
    # CORREÇÃO PERFORMANCE — monotonically_increasing_id evita shuffle global
