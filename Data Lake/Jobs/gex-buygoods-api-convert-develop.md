...
| Script | `s3://gex-datalake-bronze-develop/scripts/buygoods_api/job_convert.py` |
| Criado | 2026-05-28 11:40:34.164000-03:00 |
| Modificado | 2026-05-28 11:40:34.164000-03:00 |
...
|---|---|
| `--env` | develop |
| `--extra-py-files` | s3://gex-datalake-bronze-develop/scripts/buygoods_api/buygoods_api_libs.zip |
...
> Fonte: `s3://gex-datalake-bronze-develop/scripts/buygoods_api/job_convert.py` — baixado do S3 (read-only).
