...
| Script | `s3://gex-datalake-bronze-develop/scripts/buygoods_orders_silver_to_mysql.py` |
| Criado | 2026-06-01 13:14:34.472000-03:00 |
| Modificado | 2026-06-01 13:14:34.472000-03:00 |

## Parâmetros de negócio

| Argumento | Valor |
|---|---|
| `--DB_TABLE` | buygoods_silver_orders_dev |
| `--GLUE_CONNECTION_NAME` | gex-mysql-connection-develop |
| `--MIN_ROWS_THRESHOLD` | 100 |
| `--SOURCE_DATABASE` | gex_db_develop_silver |
| `--SOURCE_LOCATION` | s3://gex-datalake-silver-develop/buygoods_orders_dev/ |
| `--SOURCE_TABLE` | buygoods_orders_dev |
...
> Fonte: `s3://gex-datalake-bronze-develop/scripts/buygoods_orders_silver_to_mysql.py` — baixado do S3 (read-only).
